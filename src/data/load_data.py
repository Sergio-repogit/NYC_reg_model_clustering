...
from utils.config import (
    DATA_RAW_PATH, DATA_PROCESSED_DIR, 
    NUMERIC_COLS, CATEGORICAL_COLS, ID_COLS, TARGET_COL
)
from utils.helpers import setup_logging, timer, print_dataframe_info, check_data_quality
...
def validate_columns(df: pd.DataFrame, required_cols: list) -> bool:
    ...
    logger.info(f" Validación de columnas exitosa")
    return True
