...
def plot_comparison_bars(data: list, labels: list, title: str = ""):
    ...
    fig = go.Figure(data=[
        go.Bar(name=labels[i], x=labels, y=data[i])
...
def plot_metric_card(title: str, value: str, delta: str = "",
                    color: str = "#FF5A5F", icon: str = ""):
...
def styled_dataframe(df: pd.DataFrame, highlight_cols: list = None,
