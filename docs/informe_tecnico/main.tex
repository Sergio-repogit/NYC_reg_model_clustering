...
\title{
    \vspace{-2cm}
    \includegraphics[width=0.4\textwidth]{../../streamlit_app/assets/images/logo.png}\\[1cm]
...
\include{capitulos/02_eda}
\include{capitulos/03_feature_engineering}
\include{capitulos/04_clustering}
\include{capitulos/05_modelado}
\include{capitulos/06_despliegue}
